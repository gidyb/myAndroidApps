...
public class AllergicReactionActivity extends MedicalIssueActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		instruction2.setText("\u200Fאם וכאשר הנך מבחינה בתסמינים אלו:");
		
		TextView instruction3 = (TextView) findViewById(R.id.instruction3);
		instruction3.setText("\u200Fבמידה והנפגע סובל מאלרגיה ידועה וקיים ברשותו תכשיר טיפולי, עזרי לו להשתמש בו או השתמשי בו בעצמך על פי הוראות השימוש");
		
		TextView instruction4 = (TextView) findViewById(R.id.instruction4);
		instruction4.setText("\u200Fהרגיעי את הנפגע עד להגעת האמבולנס");
