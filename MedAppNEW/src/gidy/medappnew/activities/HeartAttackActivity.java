...
import gidy.medappnew.videoActivities.HeartAttackVideoActivity;
...
public class HeartAttackActivity extends MedicalIssueActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		instruction2.setText("\u200Fודאי כי הנפגע נמצא בתנוחה נוחה עבורו ונשען על משהו");
		
		TextView instruction3 = (TextView) findViewById(R.id.instruction3);
		instruction3.setText("\u200Fהרגיעי את הנפגע באופן מתמיד עד להגעת האמבולנס");
