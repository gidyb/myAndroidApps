...
import gidy.medappnew.videoActivities.BurnVideoActivity;
...
public class BurnActivity extends MedicalIssueActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		instruction1.setText("\u200Fהחזיקי את אזור הכוויה מתחת למים קרים זורמים למשך 10 דקןת לפחות");
		
		TextView instruction2 = (TextView) findViewById(R.id.instruction2);
		instruction2.setText("\u200Fכסי את אזור הכוויה באמצעות שקית פלסטיק באופן רופף");
