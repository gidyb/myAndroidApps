...
import gidy.medappnew.videoActivities.UnconsciousBreatingVideoActivity;
...
public class UnconsciousBreatingActivity extends MedicalIssueActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		instruction1.setText("\u200Fהשכיבי את הנפגע על צידו והטי ראשו לאחור");
		
		TextView instruction2 = (TextView) findViewById(R.id.instruction2);
		instruction2.setText("\u200Fהמשיכי לעקוב אחרי הנפגע עד להגעת האמבולנס");
