...
import gidy.medappnew.videoActivities.PoisoningVideoActivity;
...
public class PoisoningActivity extends MedicalIssueActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		instruction1.setText("\u200Fנסי לקבוע מה הנפגע צרך, מתי ובאיזו כמות");
		
		TextView instruction2 = (TextView) findViewById(R.id.instruction2);
		instruction2.setText("\u200Fאל תגרמי לנפגע להקיא!");
