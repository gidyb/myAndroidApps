...
import gidy.medappnew.videoActivities.StrokeVideoActivity;
...
public class StrokeActivity extends MedicalIssueActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		instruction1.setText("\u200Fבדקי האם יש לנפגע חולשה בצד אחד של הפנים");
		
		TextView instruction2 = (TextView) findViewById(R.id.instruction2);
		instruction2.setText("\u200Fבדקי האם הנפגע יכול להרים את שתי ידיו");
		
		TextView instruction3 = (TextView) findViewById(R.id.instruction3);
		instruction3.setText("\u200Fבדקי האם דיבורו של הנפגע מובן");
		...
		instruction5.setText("\u200Fדברי עם הנפגע על מנת להרגיעו עד להגעת האמבולנס");
