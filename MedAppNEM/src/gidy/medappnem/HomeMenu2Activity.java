...
public class HomeMenu2Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_home_menu_2);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.home_menu2, menu);
		return true;
	}
	
	public void toHomeMenu3(View view){
		Intent intent = new Intent(this, HomeMenu3Activity.class);
