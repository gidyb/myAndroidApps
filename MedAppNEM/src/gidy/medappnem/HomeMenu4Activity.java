...
public class HomeMenu4Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_home_menu4);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.home_menu4, menu);
		return true;
	}
	
	public void toHomeMenu5(View view){
		Intent intent = new Intent(this, HomeMenu5Activity.class);
