...
import gidy.medappnem.videoActivities.UnconsciousNotBreathingVideoActivity;
...
public class UnconsciousNotBreathingActivity extends MedicalIssueActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		instruction1.setText("\u200Fדחוף חזק את מרכז החזה של הנפגע כלפי מטה ושחרר");
		
		TextView instruction2 = (TextView) findViewById(R.id.instruction2);
		instruction2.setText("\u200Fדחוף בקצב של 100 דחיפות בדקה על להגעת האמבולנס");
