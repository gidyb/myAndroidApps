...
import gidy.medappnem.videoActivities.EpilepsyVideoActivity;
...
public class EpilepsyActivity extends MedicalIssueActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		instruction1.setText("\u200Fאל תקבע את הנפגע אך הגן על ראשו על ידי שמיכה או פרט לבוש");
		
		TextView instruction2 = (TextView) findViewById(R.id.instruction2);
		instruction2.setText("\u200Fלאחר ההתקף עזור לנפגע לנוח על צידו עם ראשו מוטה לאחור");
