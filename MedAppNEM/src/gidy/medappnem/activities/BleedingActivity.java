...
import gidy.medappnem.videoActivities.BleedingVideoActivity;
...
public class BleedingActivity extends MedicalIssueActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		instruction1.setText("\u200Fהפעל לחץ על אזור הדימום באמצעות כל חפץ שתוכל למצוא בהישג יד על מנת לעצור או לפחות להאט את זרימת הדם");
		
		TextView instruction2 = (TextView) findViewById(R.id.instruction2);
		instruction2.setText("\u200Fהמשך להפעיל לחץ על אזור הדימום עד להגעת האמבולנס");
